...
- Capital and risk managementAltura does **not** directly trade or custody physical gold.
...
There is no obligation to deploy the full committed amount.
...
- Capital exposure limits• Strategy-level allocation caps
